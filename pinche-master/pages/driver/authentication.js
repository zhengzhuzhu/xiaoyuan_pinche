...
Page({
  ...
  driver_img_input: function(e) {
    var a = e.currentTarget.dataset.idx, t = this.data.cad_cae, n = this;
    wx.chooseImage({
        count: 1,
        success: function(e) {
            t[a].img = e.tempFilePaths[0], t[a].changed = !0, console.log(e), n.setData({
                cad_cae: t
            });
        }
    });
